                        ...
                        <div class="navbar-nav w-100">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-transparent border-0">
                                    ...
                                    <a href="listeports.html" class="dropdown-item">Liste Ports</a>
                                </div>
                            </div>
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Gestion Marin</a>
                            <div class="dropdown-menu bg-transparent border-0">
                ...
                <div class="bg-secondary text-center rounded p-4">
                    <form class="mb-4">
                        <div class="input-group justify-content-lg-start">
                            <input class="form-control" type="search" placeholder="Chercher Marin">
